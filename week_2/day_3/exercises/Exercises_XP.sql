...
-- NOTE: Creating a VIEW can be a shortcut for frequently used joins.
-- Example: a view for rentals_out.
...
--    sum of length of every inventory item, excluding not yet returned.
